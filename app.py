...
with tab_home:
    ...
    <div class="section-alt" id="how-it-works">
      ...
      <div class="section-desc">Upload a scan, provide clinical details — Hemo Check runs both the
      imaging AI and the clinical risk model together, fusing results into one combined assessment.</div>
